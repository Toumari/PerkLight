...
class KillerPerk extends Perk {
  KillerPerk(int id, String name, String description, String iconFilename)
      : super(id, name, description, iconFilename, PerkType.killer);
  KillerPerk.fromJson(Map<String, dynamic> m) : super.fromJson(m, PerkType.killer);
}

class SurvivorPerk extends Perk {
  SurvivorPerk(int id, String name, String description, String iconFilename)
      : super(id, name, description, iconFilename, PerkType.killer);
...
class PerkPreference {
  ...
  Map<String, dynamic> toJson() => {'perkId': perkId, 'unlocked': unlocked, 'enabled': enabled};
